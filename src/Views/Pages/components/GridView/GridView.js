...
const GridView = (props) => {
    ...
    return (<AgGridReact enableRtl pagination={true} paginationPageSize={10} rowSelection={'multiple'}
        rowMultiSelectWithClick={true} {...props}
        rowClass="agRowStyle" rowData={props.listModel} onGridReady={onGridReady} >
        {
            props.children
        }
    </AgGridReact>)
